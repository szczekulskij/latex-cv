...
\runsubsection{Improving DDPG with SWA financial applications}
...
\runsubsection{ML models implementations from scratch }
\descript{| Python, Numpy, scikit-learn}
\location{2017-2021}
\begin{tightemize}
...
\runsubsection{medical research}
\descript{| Python, pandas, matplotlib}
...
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\descript{Relaxation}
\location{Cooking, Video Games \& Guitar}
