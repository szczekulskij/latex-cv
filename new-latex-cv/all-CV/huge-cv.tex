...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{I led the experiment-able widgets project, which enabled the company to quickly and dynamically test changes to website's via A/B testing, leading to 60 new effortless experiments and estimated 5\% increase in YoY revenue}
        \resumeItem{As a part of this project, I designed and implemented integration between an integral widget-serving backend together with experiment(a/b testing) backend, as well as web server application}
        \resumeItem{Brought up to speed and re-factored outdated internal experiments backend together with appropriate databases.}
        \resumeItem{Altered multiple internal frontends to support new experimental features. Frontends were written both in AngularJS and React}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Worked on finding ways to increase the efficiency of geometric reconstruction of nanowires through the application of Convolutional Neural Networks (CNNs) for reconstruction angles prediction}
      \resumeItemListEnd

      \resumeSubheading
      {UCSD - Cognitive Robotics Laboratory}{September 2023 -- Present}
      {Research Assistant}{San Diego, USA}
      \resumeItemListStart
