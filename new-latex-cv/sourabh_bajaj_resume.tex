...
\begin{center}
    {\Huge \scshape Jan Szczekulski} \\ \vspace{1pt}
    ...
    %\resumeSubHeadingListStart
        \begin{multicols}{4}
            \begin{itemize}[itemsep=-5pt, parsep=3pt]
                \item\small Robotics and Autonomous Systems
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Worked on research concerning long-term approach to treating PWS birthmark.}
        \resumeItem{Conducted data analysis of the past treatments to determine the best treatment for PWS birtmarks}
        \resumeItem{Utilized CNNs and transfer learning to roughly predict the patient's treatment's results.}
      \resumeItemListEnd


      \resumeSubheading
      {Lazarski University}{June 2020 -- Aug 2020; Aug 2022 - Aug 2023}
