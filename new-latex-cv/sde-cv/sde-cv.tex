...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{I'm currently working on developing a new re-arrangement planning algorithm for a tabletop rearrangement task as a part of a bigger "home robot" project}
      \resumeItemListEnd
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Java, JavaScript, SQL, graphQL, Python, Shell, HTML/CSS,  C++,} \\
